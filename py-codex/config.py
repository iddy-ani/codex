...
# OPENAI_BASE_URL is only needed for standard OpenAI, not Azure OpenAI
OPENAI_BASE_URL = os.environ.get("OPENAI_BASE_URL", "")
OPENAI_TIMEOUT_MS = int(os.environ.get("OPENAI_TIMEOUT_MS", 0)) or None

# Azure OpenAI configuration (hardcoded)
AZURE_OPENAI_ENDPOINT = "https://appi-gpt4.openai.azure.com/"
...
class AppConfig(TypedDict):
    ...
    # Standard OpenAI configuration (only used when not using Azure)
    base_url: str | None
    timeout: float | None
